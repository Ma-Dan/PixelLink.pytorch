...
def googlenet_onnx(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:
        ...
        if not original_aux_logits:
            ...
            model.aux1 = None
            model.aux2 = None'''
        pretrained_model = model_zoo.load_url(model_urls['googlenet'])
...
class GoogLeNet(nn.Module):
    ...
    def __init__(self, num_classes=1000, aux_logits=True, transform_input=False, init_weights=True,
        ...
        # Lateral layers
        self.latlayer1 = nn.Conv2d(480, 256, kernel_size=1, stride=1, padding=0)
        self.latlayer1_bn = nn.BatchNorm2d(256)
        self.latlayer1_relu = nn.ReLU(inplace=True)

        self.latlayer2 = nn.Conv2d(192, 256, kernel_size=1, stride=1, padding=0)
    ...
    def forward(self, x):
        ...
        cls_logits, link_logits = self._forward(x)
        ...
        return pixel_pos_scores, link_pos_scores
