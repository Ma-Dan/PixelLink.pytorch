...
ic17_root_dir = './data/icdar2017/'
ic17_train_data_dir = ic17_root_dir + 'train_images/'
ic17_train_gt_dir = ic17_root_dir + 'train_labels/'
ic17_test_data_dir = ic17_root_dir + 'ch4_test_images/'
ic17_test_gt_dir = ic17_root_dir + 'ch4_test_localization_transcription_gt/'
...
class IC17Loader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.is_transform:
            ...
            #print(img_path, img.shape, img.max(), img.min())
...
def test():
    ...
    import matplotlib.pyplot as plt
    dataloader=IC17Loader(is_transform=True)
